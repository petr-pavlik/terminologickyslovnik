...
\begin{itemize}
  \item $D$ – sytostní doplněk (kPa),
  \item $e_s$ – nasycený tlak vodní páry při dané teplotě (kPa),
  \item $e_a$ – aktuální (skutečný) tlak vodní páry (kPa).
\end{itemize}
...
\begin{itemize}
  ...
  \item $c_p$ – měrná tepelná kapacita vzduchu (J·kg⁻¹·K⁻¹),
  \item $A$ – průměrná amplituda rampy (°C·s),
  \item $\tau$ – průměrná doba trvání rampy (s),
  \item $\alpha$ – empirický kalibrační koeficient.
\end{itemize}
