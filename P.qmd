...
kde:\   
– $\lambda ET$ je latentní tok tepla (W·m⁻²),\ 
– $R_n$ tok čisté sálavé energie (W·m⁻²),\ 
– $G$ tok tepla do půdy (W·m⁻²), \ 
– $\rho$ hustota vzduchu (kg·m⁻³),\ 
– $c_p$ měrná tepelná kapacita vzduchu při stálém tlaku $(\mathrm{J\cdot kg^{-1}\cdot K^{-1}})$,\ 
– $(e_s - e_a)$ rozdíl mezi nasyceným a skutečným tlakem vodní páry $(\mathrm{Pa})$,\ 
– $r_a$ aerodynamický odpor $(\mathrm{s·m^{-1}})$, \
