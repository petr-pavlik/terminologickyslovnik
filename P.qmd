...
kde:<br>
– $\lambda ET$ je latentní tok tepla (W·m⁻²),<br>
– $R_n$ tok čisté sálavé energie (W·m⁻²),<br>
– $G$ tok tepla do půdy (W·m⁻²),<br>
– $\rho$ hustota vzduchu (kg·m⁻³),<br>
– $c_p$ měrná tepelná kapacita vzduchu při stálém tlaku (J·kg⁻¹·K⁻¹),<br>
– $(e_s - e_a)$ rozdíl mezi nasyceným a skutečným tlakem vodní páry (Pa),<br>
– $r_a$ aerodynamický odpor (s·m⁻¹),<br>
– $r_s$ stomatární (povrchový) odpor (s·m⁻¹),<br>
– $\Delta$ směrnice křivky nasycení vodní párou (Pa·K⁻¹),<br>
...
kde:<br>
– $c_p$ je měrná tepelná kapacita suchého vzduchu při stálém tlaku (J·kg⁻¹·K⁻¹),<br>
– $AP$ atmosférický tlak (Pa),<br>
– $\varepsilon$ poměr molekulových hmotností vodní páry a suchého vzduchu (≈ 0,622),<br>
